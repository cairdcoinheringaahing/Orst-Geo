...
commands = {
    ...
    'Ꮁ':lambda index, stacks: AttrDict(
        ...
        call = iterate(nest(abs, operator.sub)),
        arity = 2,
        new = index,
    ),
    ...
    'Ꮎ':lambda index, stacks: AttrDict(
        ...
        call = iterate(partial(operator.pow, 2)),
        arity = 1,
        new = index,
    ),
    ...
    'Ꮑ':lambda index, stacks: AttrDict(
        ...
        call = iterate(partial(operator.pow, 10)),
        arity = 1,
        new = index,
    ),
    ...
    'Ꮓ':lambda index, stacks: AttrDict(
        ...
        call = iterate(helpers.subfactorial),
        arity = 1,
        new = index,
    ),
    ...
    'Ꮕ':lambda index, stacks: AttrDict(
        ...
        call = iterate(partial(operator.truediv, 1)),
        arity = 1,
        new = index,
    ),
    ...
    'Ꮛ':lambda index, stacks: AttrDict(
        ...
        call = iterate(partial(operator.lt, 0)),
        arity = 1,
        new = index,
    ),
    ...
    'Ꮚ':lambda index, stacks: AttrDict(
        ...
        call = iterate(partial(helpers.nfind, helpers.isprime, tail = True)),
        arity = 1,
        new = index,
    ),
    ...
    'Ꮘ':lambda index, stacks: AttrDict(
        ...
        call = iterate(partial(helpers.invariant, nest(partargs(operator.pow, {2: 2}), int, math.sqrt))),
        arity = 1,
        new = index,
    ),
    ...
    'Ꮖ':lambda index, stacks: AttrDict(
        ...
        call = iterate(partial(operator.gt, 0)),
        arity = 1,
        new = index,
    ),
    ...
    'ћ':lambda index, stacks: AttrDict(
        ...
        call = iterate(helpers.prime_index),
        arity = 1,
        new = index,
    ),
    ...
    '≠':lambda index, stacks: AttrDict(
        doc = 'Filter on primes (array → array)',
        call = partial(filter, isprime),
        arity = 1,
        new = index,
    ),

    '†':lambda index, stacks: AttrDict(
        doc = 'Variance (array → real)',
        call = statistics.variance,
        arity = 1,
        new = index,
    ),
    ...
    'ƒ':lambda index, stacks: AttrDict(
        doc = 'Harmonic mean (array → num)',
        call = statistics.harmonic_mean,
        arity = 1,
        new = index,
    ),
    
    '¬':lambda index, stacks: AttrDict(
        doc = 'Standard deviation (array → real)',
        call = statistics.stdev,
        arity = 1,
        new = index,
    ),

    'µ':lambda index, stacks: AttrDict(
        doc = 'Arithmetic mean (array → num)',
        call = statistics.mean,
        arity = 1,
        new = index,
    ),

    'ﬁ':lambda index, stacks: AttrDict(
        doc = 'Median (array → num)',
        call = statistics.median,
        arity = 1,
        new = index,
    ),

    'ﬂ':lambda index, stacks: AttrDict(
        doc = 'Mode (array → int)',
        call = statistics.mode,
        arity = 1,
        new = index,
    ),
    ...
    '⁽':lambda index, stacks: AttrDict(
        doc = 'Inverse matrix ([array] → [array])',
        call = helpers.inv,
        arity = 1,
        new = index,
    ),
    ...
    '⁾':lambda index, stacks: AttrDict(
        doc = 'Lowest common multiple (LCM) (int → int → int)',
        call = helpers.lcm,
        arity = 2,
        new = index,
    ),
    ...
    '÷':lambda index, stacks: AttrDict(
        doc = 'Lowest common multiple (LCM) of an array (int → int)',
        call = helpers.lcm,
        arity = 1,
        new = index,
    ),
    ...
    'ªα':lambda index, stacks: AttrDict(
        doc = 'Divisor count (int → int)',
        call = iterate(nest(len, helpers.factors)),
        arity = 1,
        new = index,
    ),

    'ªά':lambda index, stacks: AttrDict(
        doc = 'Proper divisor count (int → int)',
        call = iterate(nest(len, partial(helpers.factors, proper = True))),
        arity = 1,
        new = index,
    ),
    ...
    'ªλ':lambda index, stacks: AttrDict(
        doc = 'Proper divisor sum (int → int)',
        call = iterate(nest(sum, partial(helpers.factors, proper = True))),
        arity = 1,
        new = index,
    ),
    ...
    'ºÀ':lambda index, stacks: AttrDict(
        doc = 'Yield "`1234567890-=qwertyuiop[]asdfghjkl;\'#\zxcvbnm,./"',
        call = nilad("`1234567890-=qwertyuiop[]asdfghjkl;\'#\zxcvbnm,./"),
        arity = 0,
        new = index,
    ),

    'ºÁ':lambda index, stacks: AttrDict(
        doc = 'Yield \'¬!"£$%^&*()_+QWERTYUIOP{}ASDFGHJKL:@~|ZXCVBNM<>?\'',
        call = nilad('¬!"£$%^&*()_+QWERTYUIOP{}ASDFGHJKL:@~ZXCVBNM<>?'),
        arity = 0,
        new = index,
    ),

    'ºÂ':lambda index, stacks: AttrDict(
        doc = 'Yield \'qwertyuiopasdfghjklzxcvbnm\'',
        call = nilad('qwertyuiopasdfghjklzxcvbnm'),
        arity = 0,
        new = index,
    ),

    'ºÄ':lambda index, stacks: AttrDict(
        doc = 'Yield \'QWERTYUIOPASDFGHJKLZXCVBNM\'',
        call = nilad('QWERTYUIOPASDFGHJKLZXCVBNM'),
        arity = 0,
        new = index,
    ...
    'ºÆ':lambda index, stacks: AttrDict(
        doc = 'Yield \'zyxwvutsrqponmlkjihgfedcba\'',
        call = nilad('zyxwvutsrqponmlkjihgfedcba'),
        arity = 0,
        new = index,
    ),

    'ºÃ':lambda index, stacks: AttrDict(
        doc = 'Yield \'ZYXWVUTSRQPONMLKJIHGFEDCBA\'',
        call = nilad('ZYXWVUTSRQPONMLKJIHGFEDCBA'),
        arity = 0,
        new = index,
    ...
    'ºÅ':lambda index, stacks: AttrDict(
        doc = 'Yield \'aeiou\'',
        call = nilad('aeiou'),
        arity = 0,
        new = index,
    ...
    'ºĀ':lambda index, stacks: AttrDict(
        doc = 'Yield \'AEIOU\'',
        call = nilad('AEIOU'),
        arity = 0,
        new = index,
    ...
    'ºĄ':lambda index, stacks: AttrDict(
        doc = 'Yield \'aeiouy\'',
        call = nilad('aeiouy'),
        arity = 0,
        new = index,
    ...
    'ºB':lambda index, stacks: AttrDict(
        doc = 'Yield \'AEIOUY\'',
        call = nilad('AEIOUY'),
        arity = 0,
        new = index,
    ...
    'ºC':lambda index, stacks: AttrDict(
        doc = 'Yield \'bcdfghjklmnpqrstvwxyz\'',
        call = nilad('bcdfghjklmnpqrstvwxyz'),
        arity = 0,
        new = index,
    ),

    'ºĆ':lambda index, stacks: AttrDict(
        doc = 'Yield \'BCDFGHJKLMNPQRSTVWXYZ\'',
        call = nilad('BCDFGHJKLMNPQRSTVWXYZ'),
        arity = 0,
        new = index,
    ...
    'ºČ':lambda index, stacks: AttrDict(
        doc = 'Yield \'bcdfghjklmnpqrstvwxz\'',
        call = nilad('bcdfghjklmnpqrstvwxz'),
        arity = 0,
        new = index,
    ),

    'ºÇ':lambda index, stacks: AttrDict(
        doc = 'Yield \'BCDFGHJKLMNPQRSTVWXZ\'',
        call = nilad('BCDFGHJKLMNPQRSTVWXZ'),
        arity = 0,
        new = index,
    ...
    'ºD':lambda index, stacks: AttrDict(
        doc = 'Yield \'abcde\'',
        call = nilad('abcde'),
        arity = 0,
        new = index,
    ...
    'ºĎ':lambda index, stacks: AttrDict(
        doc = 'Yield \'ABCDE\'',
        call = nilad('ABCDE'),
        arity = 0,
        new = index,
    ...
    # ÐEÈÉÊËĒĖĚĘFGHIÌÍÎÏĪĮJKLĹĽŁMNŃŇÑŊOÒÓÔÖŒÕØŌPQRŔŘSŚŠTŤŦUÙÚÛÜŮŪVWŴXYÝŶŸZŹŽŻaàáâäæãåāąbcćčçdďðeèéêëēėěęfghiìíîïīįjklĺľłmnńňñŋoòóôöœøōõpqrŕřsßśštťŧuùúûüůūvwŵxyýŷÿzźžżΑΆΒΓΔΕΈΖΗΉΘΙΊΚΛΜΝΞΟΌΠΡΣΤΥΎΦΧΨΩΏαάβγδεέζηήθιί
    ...
    # λμνξοόπσςτυύΰφχψωώ0123456789. ",ᏣᏤᏥᏦᏧᏨᏔᏖᏘᎧᎿᏀᏍᏜᏮᏭᏬᏫᏩᏪᏴᏳᏲᏱᏰᏯᎦᎨᎩᎪᎫᎬᎭᎮᎯᎰᎱᎲᎳᎴᎵᎶᎷᎸᎹᎺᎻᎼᎽᏂᎾᏁᏃᏄᏅᏋᏊᏈᏆᏇᏉᏒᏑᏏᏌᏎᏐᏛᏚᏙᏗᏓᏕᏢᏡᏠᏟᏞᏝᎡᎢᎣᎤᎥ₽¥£$¢€₩[&…§]ЉЊЕРТЗУИОПШАСДФГХЈКЛЧЋЅЏЦВБНМЂЖљњертзуиопшасдфгхјклчћѕџцвбнмђж¤þ{@%‰#}(?¿!¡)ªº‹›°◊•—/\:;”“„'’‘`^*+=_|~-<≤«·»≥>ᴇ¶ˋˆ¨´ˇ∞≠†∂ƒ⋮¬≈µﬁﬂ×⁰¹²³⁴⁵⁶⁷⁸⁹⁺⁻⁼⁽⁾÷₀₁₂₃₄₅₆₇₈₉₊₋₌₍₎
